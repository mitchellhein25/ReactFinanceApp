    ...
    return (
        <Paper className={classes.paper}>
            <form className={`${classes.root} ${classes.form}`} autoComplete="off" noValidate onSubmit={handleSubmit}>
                ...
                <TextField  name="name" variant="outlined" label="Name" type="name" fullWidth value={budgetData.name}
                ...
                />
                <TextField name="amount" variant="outlined" type="number" label="Amount" fullWidth value={budgetData.amount}  onChange={(e) => setBudgetData({ ...budgetData, amount: e.target.value })} />
                <div>
